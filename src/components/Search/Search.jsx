  ...
  return (
    <div className='absolute inset-x-0 sm:top-16 md:50 lg:top-72'>
          ...
          <form className='flex justify-center drop-shadow-lg'>
            <input type="text" placeholder='You Can Search Properties By: Location, Property Type, or Income... ' className='border-2 border-purple-900 p-3 rounded-bl-3xl w-1/2 sm:w-20 sm:h-10'/>
