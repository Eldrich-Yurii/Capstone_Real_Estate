...
function Search() {
  return (
    <div className='absolute inset-x-0 sm:top-36 md:50 lg:top-72'>
          ...
          <form className='flex justify-center drop-shadow-lg'>
            <input type="text" placeholder='You Can Search Properties By: Location, Property Type, or Income... ' className='border-2  border-purple-900 p-3 w-1/2 rounded-bl-3xl sm:w-50'/>
