  ...
  return (
    <div className='absolute inset-x-0 top-16'>
          ...
          <form className='flex justify-center drop-shadow-lg'>
            <input type="text" placeholder='You Can Search Properties By: Location, Property Type, or Income... ' className='border-2 border-purple-900 p-3 rounded-bl-3xl h-10'/>
